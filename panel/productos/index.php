    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="../dashboard.php">DevelopApp Store</a>
        </div>
      ...
      <div class="row">
        <div class="col-md-12">
            <div class="pull-right">
                <a href="registrar.php" class="btn btn-primary">Nuevo</a>
            </div>
        </div>
      </div>
                ...
                <?php
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        ...
                        <a href="actualizar.php?id=<?php print $item['id']  ?>" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-edit"></span></a>
                      </td>
